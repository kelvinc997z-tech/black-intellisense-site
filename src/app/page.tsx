    ...
    <div className="min-h-screen bg-[#020205] text-white selection:bg-blue-500/30 font-sans tracking-tight overflow-x-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-40 pb-20 z-10 text-center">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black tracking-tighter text-white mb-8 leading-[1.1] uppercase italic mix-blend-difference">
          ...
          <p className="max-w-3xl mx-auto text-base md:text-lg lg:text-xl text-white/40 mb-16 font-medium leading-relaxed tracking-tight animate-in fade-in duration-1000 delay-600 fill-mode-both px-4">
      ...
      <section id="products" className="relative py-60 z-10 overflow-hidden">
        <div className="max-w-7xl mx-auto px-8 text-center">
          ...
          <h3 className="text-4xl md:text-6xl font-black text-white leading-[1] tracking-tighter uppercase mb-20 italic reveal">Proprietary <br /> Ecosystem</h3>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="bg-gradient-to-br from-blue-900 via-[#05050a] to-black rounded-[6rem] p-16 md:p-40 relative overflow-hidden shadow-[0_0_200px_rgba(59,130,246,0.2)] border border-white/10 group/form">
            ...
            <div className="relative z-10 text-center mb-32">
               <h2 className="text-4xl md:text-6xl font-black tracking-tighter text-white mb-10 uppercase italic leading-[1] drop-shadow-2xl animate-pulse-slow">Connect <br /> The Future</h2>
      ...
      <footer className="py-48 z-10 relative px-8 bg-black border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-24">
          <div className="flex flex-col items-center gap-10">
            ...
            <span className="text-4xl md:text-6xl font-black italic tracking-[-0.05em] uppercase text-center leading-none text-white">BLACKINTELLI<span className="text-blue-500">SENSE</span></span>
