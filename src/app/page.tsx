          ...
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-5 group cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
              ...
              <div className="flex flex-col leading-none">
                <span className="text-3xl font-black tracking-tighter italic uppercase">BLACK<span className="text-blue-500 ml-1">INTELLI</span></span>
      ...
      <footer className="py-48 z-10 relative px-8 bg-black border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-24">
          <div className="flex flex-col items-center gap-10">
            ...
            <span className="text-6xl md:text-8xl font-black italic tracking-[-0.05em] uppercase text-center leading-none">BLACK <br className="md:hidden" /><span className="text-blue-500">INTELLISENSE</span></span>
